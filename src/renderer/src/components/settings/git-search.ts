  ...
  return [
    {
      ...
      keywords: [
        ...translateSearchKeyword(
          'auto.components.settings.git.search.f83c8937c4',
          'branch naming'
        ),
        ...translateSearchKeyword(
          'auto.components.settings.git.search.1d2fae1fa2',
          'git username'
        ),
    ...
    },
    {
      ...
      keywords: [
        ...
        ...translateSearchKeyword(
          'auto.components.settings.git.search.stagedFirst',
          'staged first'
        ),
        ...translateSearchKeyword(
    ...
    },
    {
      ...
      keywords: [
        ...translateSearchKeyword(
          'auto.components.settings.git.search.compareBase',
          'compare base'
        ),
        ...translateSearchKeyword(
